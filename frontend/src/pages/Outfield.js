  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-primary/5">
      <div className="container mx-auto px-4 md:px-8 max-w-4xl py-32 text-center">
        ...
        <p className="text-xl md:text-2xl leading-relaxed text-muted-foreground font-body mb-12 max-w-2xl mx-auto">
          A new perspective on sports business is coming your way. Stay tuned for something exciting.
        </p>
        
        <div className="relative max-w-2xl mx-auto">
          <div className="absolute inset-0 bg-primary/5 blur-3xl" />
          <div className="relative bg-card border-2 border-primary/20 shadow-xl p-12">
            <h3 className="text-2xl font-heading font-bold mb-4">Get notified when we launch</h3>
            <p className="text-base text-muted-foreground mb-6">Be among the first to explore The Outfield</p>
            <div className="flex gap-3">
              <input 
                type="email" 
                placeholder="your@email.com"
                className="flex-1 px-4 py-3 border-2 border-border bg-background text-foreground focus:border-primary outline-none transition-colors font-body"
              />
              <button className="bg-primary text-white hover:bg-primary/90 font-semibold px-6 transition-all hover:shadow-lg">
                Notify Me
              </button>
            </div>
          </div>
