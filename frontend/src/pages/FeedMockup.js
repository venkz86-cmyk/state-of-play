...
export const FeedMockup = () => {
  ...
  if (loading) {
    return (
      <MockupLayout testId="mockup-feed" seo={{ title: 'Latest', path: '/state-of-play', description: 'The latest reportage and analysis from The State of Play, India\'s sports business desk.' }}>
