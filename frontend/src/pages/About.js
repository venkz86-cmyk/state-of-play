    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          ...
          <div className="mb-16">
            <h2 className="text-3xl font-heading font-bold mb-8">Why Global Sports Investors Read <span className="text-primary" style={{ fontStyle: 'italic', fontWeight: 400, fontFamily: 'Merriweather, Georgia, serif' }}>The State of Play</span></h2>
