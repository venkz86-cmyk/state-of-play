...
export const AboutMockup = () => (
  <MockupLayout testId="mockup-about" seo={{ title: 'About', path: '/about', description: 'About The State of Play, a sports business publication out of Bengaluru. Reportage, analysis, and intelligence on the people, money, and decisions shaping Indian sport.' }}>
    ...
    <section className="max-w-[1280px] mx-auto px-6 lg:px-12 pb-32">
      <div className="border-t border-[var(--text)] pt-8 grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        ...
        <div className="lg:col-span-9 max-w-[60ch]">
          ...
          <p className="font-plex text-base lg:text-lg leading-relaxed text-[var(--text-muted)] mb-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="mailto:venkat@stateofplay.club" className="inline-flex items-center gap-2 font-plex text-sm text-[var(--text)] underline underline-offset-[6px] decoration-1 hover:text-[var(--accent)] hover:decoration-2 transition-all">
